...
let UsageMessage = """
Usage: pdef [-v | --version] [-h | --help] [-d <domain> | --domain <domain>] <file1> <files2>

"""

let DescriptionMessage = """
pdef writes out a shell-script to stdout for changing Mac OS X User Defaults (property list) from <file1> to <file2>.
